...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
     ...
     KC_LSFT , KC_Z   , KC_X    , KC_C   , KC_V   , KC_B  ,                                        KC_N    , KC_M   , KC_COMM, KC_DOT  , KC_SLSH  , KC_DEL ,
                                           CC_CLSH, LSFT_SPC, TD(_NUMPAD),           TD(_SYMBOLS), LSFT_ENT, CC_CLSH
    ),
    ...
    [_SYMBOLS] = LAYOUT_split_3x6_3(
     ...
     KC_PIPE , CC_GAMM, CC_SIGM, CC_RHO , CC_SNEK, TD_PIPE,                                     KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_TILD, KC_QUES,
                                          XXXXXXX,CC_SHLD, NAV    ,               TG(_SYMBOLS), XXXXXXX, XXXXXXX         
    ),
    ...
    [_NUMPAD] = LAYOUT_split_3x6_3(
      ...
      XXXXXXX, DF(_BASE),       XXXXXXX, DT_UP  , DT_DOWN, DT_PRNT ,                                     XXXXXXX,      KC_1   , KC_2   , KC_3   , XXXXXXX, XXXXXXX,
                                          XXXXXXX, XXXXXXX , TG(_NUMPAD),               NAV    , RSFT_T(KC_0), XXXXXXX
    ),
    [_NAV] = LAYOUT_split_3x6_3(
      ...
      XXXXXXX, KC_KB_MUTE       , KC_F1  , KC_F2  , KC_F3  , KC_F12 ,                                     KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX,
                                                    XXXXXXX, XXXXXXX, TG(_NAV),                 TG(_NAV), XXXXXXX, XXXXXXX
    ),
    [_MOUSE] = LAYOUT_split_3x6_3(
      XXXXXXX,  XXXXXXX,     KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, XXXXXXX,                                           LGUI(KC_LBRC), LCTL(LSFT(KC_TAB)),   RCTL(KC_TAB),       LGUI(KC_RBRC), KC_TRANSPARENT, XXXXXXX,
      XXXXXXX,  XXXXXXX,     KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    MT(MOD_LGUI,KC_DEL),                               XXXXXXX,       MT(MOD_RGUI,KC_DOWN), MT(MOD_RALT,KC_UP), XXXXXXX,       KC_ENTER,       XXXXXXX,
      XXXXXXX,  XXXXXXX,     KC_MS_BTN2,     KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_TRANSPARENT,                                    KC_MS_BTN1,    KC_MS_ACCEL0,         KC_MS_ACCEL1,       KC_MS_ACCEL2,  KC_NO,          XXXXXXX,
                                                             XXXXXXX,        TO(_NUMPAD)   ,      TG(_MOUSE),       TG(_MOUSE), TO(_SYMBOLS),  XXXXXXX
    ),
